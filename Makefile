...
# PS2
   ...
   CFLAGS += -G0 -O3 -fno-strict-aliasing -fomit-frame-pointer -ffast-math -DPS2 -DABGR1555 -DNO_FAST_SQRT -DMEMORY_LOW -DHAVE_LOW_MEMORY -DIOAPI_NO_64 -DNDEBUG -DVIDEO_ABGR1555 -DHAVE_STRLWR
